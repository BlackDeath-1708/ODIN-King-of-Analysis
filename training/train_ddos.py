...
save_metrics(
    ...
    notes="Real hping3 SYN/UDP/spoofed-source floods + benign TCP connect() bursts, loopback + multi-host.",
)

# P10/P9: evaluate on the held-out UNSEEN multi-host scenario (ddos_multi_04,
# spoofed-source at a distinct rate profile) -- see train_recon.py's identical
# block for the full rationale.
UNSEEN_DATASET = REPO_ROOT / "training" / "dataset_ddos_unseen.csv"
if UNSEEN_DATASET.exists():
    ...
    save_metrics(
        "ddos_unseen", y_unseen, unseen_preds,
